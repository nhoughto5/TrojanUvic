...
namespace Trojan.Models
{
    public class DatabaseInit : DropCreateDatabaseIfModelChanges<TrojanContext>
    {
        ...
        protected override void Seed(TrojanContext context)
        {
            ...
            GetInsertSeverity().ForEach(c => context.InsertSeverity.Add(c));
            GetAbstractionSeverity().ForEach(c => context.AbstractionSeverity.Add(c));
            GetEffectSeverity().ForEach(c => context.EffectSeverity.Add(c));
            GetLogicTypeSeverity().ForEach(c => context.LogicTypeSeverity.Add(c));
            GetFunctionalitySeverity().ForEach(c => context.FunctionalitySeverity.Add(c));
            GetActivationSeverity().ForEach(c => context.ActivationSeverity.Add(c));
            GetPhysicalLayoutSeverity().ForEach(c => context.PhysicalLayoutSeverity.Add(c));
            GetLocationSeverity().ForEach(c => context.LocationSeverity.Add(c));
            GetChipAttributeSeverity().ForEach(c => context.ChipAttributeSeverity.Add(c));

        }

        private static List<severityRating> GetInsertSeverity()
        {
            var ratings = new List<severityRating>
            {
                new severityRating{
                    k = {"1"},
        ...
        private static List<severityRating> GetAbstractionSeverity()
        {
            var ratings = new List<severityRating>
            {
        ...
        private static List<severityRating> GetEffectSeverity()
        {
            var ratings = new List<severityRating>
            {
        ...
        private static List<severityRating> GetLogicTypeSeverity()
        {
            var ratings = new List<severityRating>
            {
        ...
        private static List<severityRating> GetFunctionalitySeverity()
        {
            var ratings = new List<severityRating>
            {
        ...
        private static List<severityRating> GetActivationSeverity()
        {
            var ratings = new List<severityRating>
            {
        ...
        private static List<severityRating> GetPhysicalLayoutSeverity()
        {
            var ratings = new List<severityRating>
            {
        ...
        private static List<severityRating> GetLocationSeverity()
        {
            var ratings = new List<severityRating>
            {
        ...
        private static List<severityRating> GetChipAttributeSeverity()
        {
            var ratings = new List<severityRating>
            {
